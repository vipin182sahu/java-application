...
public class ServletTemplate
{
  ...
  protected final String TEXT_13 = " {" + NL + "   static final long serialVersionUID = 1L;" + NL + "   " + NL + "    /* (non-Java-doc)" + NL + "\t * @see javax.servlet.http.HttpServlet#HttpServlet()" + NL + "\t */" + NL + "\tpublic ";
